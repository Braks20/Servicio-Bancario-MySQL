...
router.post('/', verificarRol('admin', 'cajero', 'cliente'), prestamoController.solicitar);
...
router.post('/:id/pagar', verificarRol('admin', 'cajero', 'cliente'), prestamoController.pagarCuota);
