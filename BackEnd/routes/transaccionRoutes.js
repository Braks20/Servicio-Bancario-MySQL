...
router.get('/', verificarRol('admin', 'cajero', 'cliente'), transaccionController.listar);
router.get('/:id', verificarRol('admin', 'cajero', 'cliente'), transaccionController.obtener);
...
router.post('/transferencia', verificarRol('admin', 'cajero', 'cliente'), transaccionController.transferencia);
